...
read_me <- tabItem(tabName = "ReadMe",
                   ...
                   h2("Features"),
                   p("This app have two tabs. The first tabs use slicer to filter Top 25 Player and Wonderkids (a player under 21 years old). The second pages show League Summary of specific league inculding the Top 5 player accouding to their position, world map of where the player come from, rating distribution, and age distribution."),
                   h2("Dataset"),
